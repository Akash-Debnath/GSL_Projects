@extends('index')
@section('title', ' ~ Employee Job-Description')
@section('wrapper')
@parent
{{-- @section('preloader')
@parent
    ...
    // echo $c[$j];
                       ...
                       @foreach($employee as $e)
                        ...
                        <tr data-widget="expandable-table" aria-expanded="true">
                            ...
                            <td>@if(!is_null($e->job_desc))<a href={{"files/".$e->job_desc->file_name}} class="btn btn-primary btn-sm">Download</a> <i class="fas fa-angle-right"></i> <a class="btn btn-warning btn-sm"  onclick="getData({{$e->job_desc->id}})"  data-toggle="modal" data-target="#change"  >Change </a>   @else 
                                
not found &nbsp;&nbsp;<i class="fas fa-angle-right"></i>&nbsp;&nbsp; <a class="btn btn-primary btn-sm" onclick="getData({{ $e->emp_id }}) " data-toggle="modal" data-target="#upload" >Upload</a>
