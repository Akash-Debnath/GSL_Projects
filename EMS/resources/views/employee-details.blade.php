    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">{{ $empInfo->userDesignation->designation }}</p>
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">
                    {{ $years ? ($years." year(s) ") : '' .$months ? ($months." month(s) ") : '' .$days ? ($days."
                    day(s) ") : '' }}
                    @php
                    // dd($months);
                    @endphp
                ...
                <p class="text-muted">Genuity Systems Ltd. is an IT company established in the year 2003, provides
        ...
        <div class="card">
            <div class="card-header p-2">
                <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link " href="#information">Information</a>
                    </li>

                    <li class="nav-item"><a class="nav-link" href="/late-early-req">late/Early request</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('evaluation.show',$empInfo->emp_id) }}">Evaluation</a></li>
                    {{-- <li class="nav-item"><a class="nav-link" href="/changePass">Change Password</a>
                    </li> --}}
                </ul>
            </div><!-- /.card-header -->
            <div class="card-body">
                ...
                <table class="table table-borderless table-info">
                    <tr class="bg-gradient-gray">
                        <td colspan="2">
                            <h6><i class="fas fa-user"></i> Information</h6>
                        </td>
                    </tr>
                    <tr>
                        <td>Employee ID</td>
                    ...
                    <tr>
                        <td>Grade</td>
                        {{-- @php
                        dd( $empInfo->userGrade);
                        @endphp --}}
                        <td>{{ $empInfo->grade ? $empInfo->grade->grade : 'None'}} &nbsp; &nbsp; <a href=""
                                class="btn  btn-warning btn-sm " data-toggle="modal" data-target="#grade">
                                change </a></td>
                    </tr>
                    <tr>
                        <td>Operational Designation</td>
                        <td>{{ $empInfo->userDesignation->designation }}</td>
                    </tr>
                    <tr>
                        <td> Department</td>
                    ...
                    @foreach ($status as $key => $value)
                        ...
                        <td>{{ $value }} 
                            ...
                            @endif
                            <a href="" class="btn  btn-warning btn-sm " data-toggle="modal" data-target="#oldStatus">Old Status </a></td>
                        @endif 
                    @endforeach
                    </tr>
                </table>
                ...
                <table class="table table-borderless table-info">
                    <tr class="bg-gradient-gray">
                        <td colspan="2" >
                            ...
                            <h6><i class="fas fa-mail-bulk"></i> Contact Information <button  class="btn btn-primary btn-xs" id="editContactBtn"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    <tbody id="editableContact">
                        <tr>
                            ...
                            <td>
                                ...
                                <div class='row'> 
                                    <div class='col-md-12'> 
                                        <input type="text" class="form-control" id="" name="mobile" value="{{ $empInfo->mobile }}"> 
                                    </div>
                                </div>
                            </td>
                        </tr> 
                        <tr>
                            ...
                            <td>
                                <div class='row'> 
                                    <div class='col-md-12'> 
                                        <input type= 'text' name="phone" class='form-control' value='{{ $empInfo->phone }}'> 
                                    </div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class='row'> 
                                    <div class='col-md-12'> 
                                        <input type='text' class='form-control' name="present_address" value='{{ $empInfo->present_address }}'> 
                                    </div> 
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class='row'> 
                                    <div class='col-md-12'> 
                                        <input type= 'text' class='form-control' name="permanent_address" value='{{ $empInfo->permanent_address }}'> 
                                    </div>
                                    <div class='col-md-2'>
                                        <button type='submit' class='btn btn-md btn-info form-control edit-emp'><i class='fas fa-check mx-auto'></i></button>
                                    </div> 
                                </div>
                            </td>
                        </tr>
                ...
                <table class="table table-info table-borderless">
                    <tr class="bg-gradient-gray">
                        <td colspan="2">
                            <h6><i class="fas fa-school"></i> Educational Information <button  class="btn btn-primary btn-xs" id="editEducationBtn"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                              </svg></button></h6>
                        </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <form>  
                                    <div class='row'> 
                                    <div class='col-md-12'> 
                                        <input type= 'text' class='form-control' name="last_edu_achieve" value='{{ $empInfo->last_edu_achieve }}'> </div> 
                                    </div>
                                    <div class='col-md-2'>
                                        <button type='submit' class='btn btn-md btn-info form-control edit-emp'><i class='fas fa-check mx-auto'></i></button>
                                    </div> 
                ...
                <table class="table table-borderless table-info" >
                    <tr class="bg-gradient-gray">
                        <td colspan="2">
                            <h6>Experience <button  class="btn btn-primary btn-xs" id="editExperienceBtn"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                              </svg></button></h6>
                        </td>
                ...
                <form action="{{ url('edit-employee-info') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <tbody id="editableExperience">
                        <tr>
                            ...
                            <td>
                                <form>
                                    <div class='row'> <div class='col-md-12'> <input type= 'text' name="experiance" class='form-control' value='{{ $empInfo->experience }}'></div>
                                    <div class='col-md-2'>
                                        <button type='submit' class='btn btn-md btn-info form-control edit-emp'><i class='fas fa-check mx-auto'></i></button>
                                    </div> </div>
                                </form>
                ...
                <table class="table table-borderless table-info emp_edit">
                    <tr class="bg-gradient-gray">
                        <td colspan="2">
                            <h6>Personal Information <button  class="btn btn-primary btn-xs" id="editPersonalInfoBtn" ><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                              </svg></button></h6>
                        </td>
                    ...
                    <tbody id="editablePersonalInfo">
                        <tr>
                            ...
                            <td>
                                <div class='row'> 
                                <div class='col-md-12'> 
                                    <input type= 'date' class='form-control' name="dob" value='{{ $empInfo->dob }}' name='dob'> 
                                </div>
                            </td>
                        </tr> 
                        <tr><td>Blood Group</td>
                            <td>
                                <div class='row'> 
                                @php  
                                    $blood= array('A+'=>'A(+)', 'A-'=>'A(-)', 'B+'=>'B(+)', 'B-'=>'B(-)', 'O+'=>'O(+)', 'O-'=>'O(-)', 'AB+'=>'AB(+)','AB-'=>'AB(-)');  
                                @endphp 
                                <div class='col-md-12'> 
                                    <select name="blood_group" class='form-control' style="padding: 0;" >
                                            <option selected hidden>--Select--</option> 
                                        @foreach($blood as $key => $value) 
                                            <option value='{{ $key }}' {{ $empInfo->blood_group == $key ? 'selected' : '' }}>{{ $value }}</option>
                                        @endforeach  
                                    </select> 
                                </div> 
                            </td>
                                ...
                                <div class='col-md-12'> 
                                    <select name="gender" class='form-control'> 
                                        @foreach($gender as $key => $value) 
                                            <option value='{{ $key }}' {{$empInfo->gender == $key ? 'selected' : '' }}>{{ $value }}</option>  
                                        @endforeach 
                                    </select> 
                                </div>
                        ...
                        <tr>
                            <td> <div class='col-md-2'>
                                <button type='submit' class='btn btn-sm btn-info   edit-emp'><i class='fas fa-check mx-auto'></i></button>
                            </div> </td>
                        </tr>
                    </tbody>
                </form>
                    ...
                    <div class="row  ">
                        <div class="col-md-6">
                            <div class="btn-group-sm">
                                <a class="btn btn-warning btn-xs" href="#">
                                    ...
                                    <form action="{{ url('archive-employee', $empInfo->emp_id) }}" method="post" >
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="archive" value="Y" hidden>
                                        <button type="submit" class="btn btn-warning btn-xs" onclick="return confirm('Are you sure want to archive employee - {{ $empInfo->name }}?')"> <i class="fas fa-folder">
                                        </i>  Archive</button>
                                    </form>
                                </a>
                                <a class="btn btn-info btn-xs" href="#">
                                    ...
                                    <form action="" method="post" >
                                        @csrf
                                        @method('PUT')
                                        <button type="submit" class="btn btn-info btn-xs" onclick="return confirm('Are you sure want to lock employee - {{ $empInfo->name }}?')"><i class="fas fa-lock-open">
                                        </i> Lock</button>
                                    </form>
                                </a>
                                <a class="btn btn-danger btn-xs" >
                                    <form action="{{ route('employees.destroy', $empInfo->id) }}" method="post" >
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure want to delete employee - {{ $empInfo->name }}?')"><i class="fa fa-trash"></i> Delete</button>
                                    </form>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex mt-2 mt-md-0">
                            <div class="btn-group-sm ml-md-auto ml-0">
                                <a class="btn btn-warning btn-sm" href="{{ route('employees.edit',$empInfo->id) }}">
                                    <i class="fas fa-edit">
                                    </i>
                                    Edit
                                </a>
                                ...
                                <div class="row my-1">
                                    <div class="col-12">
                                        <button class="btn btn-info btn-sm" data-toggle="modal"
                                            data-target="#addfacility">Add Facility</button>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                            @foreach ($faci as $fac )
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $fac->to_date }}</td>
                                                    <td>{{ $fac->remark }}</td>
                                                    <td> <a class="btn btn-sm btn-warning" onclick="getData({{ $fac->id }})" data-toggle="modal" data-target="#edit_facility"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                                      </svg></a> 
                                                      <form action="{{ url('facility-delete', $fac->id) }}" method="post" class="ml-1" >
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want to delete facility : {{ $fac->facility }}?')"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
                                    ...
                                    <form action="">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 mt-2 mt-md-0">
                                                <button type="button"
                                                    class="btn btn-primary btn-info btn-md btn-block">Add</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>  --}}
                ...
                <div class="modal fade" id="addfacility">
                    <div class="modal-dialog modal-dialog-centered " style="max-width: 800px;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="col-12">
                                    <form action="{{ url('add-facility') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hiddden" name="emp_id" value="{{ $empInfo->emp_id }}" hidden/>
                                        <div class="row">
                                            <div class="col-12">
                                        ...
                                        <div class="row d-flex justify-content-between">
                                            <div class="col-md-2">
                                                <button type="button" class="btn btn-danger btn-block btn-sm">Close</button>
                                            </div>
                                            <div class="col-md-2 mt-2 mt-md-0">
                                ...
                                <div class="col-12">
                                    <form action="{{ url('update-facility') }}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="remark">Remark</label>
                                                <textarea name="remark" id="remarks" cols="30" rows="3"
                                                    class="form-control"></textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered " style="max-width: 400px;">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <table class="table table-bordered mx-auto" style="width:85%;">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                            <form action="{{ url('update-grade', $empInfo->emp_id) }}" method="POST">
                                             @csrf
                                             @method('PUT')
                                                
                                                <tr>
                                                    <input type="hidden" name="grade_id" value="{{ $empGrade->id }}" hidden>
                                                    <td><input type="text" name="grade" id="" value="{{ $empGrade->grade }}" style="max-width: 55px;border: none;" readonly></td>
                                                    <td>3</td>
                                                    @if ($g == $eg)
                                                        <td><i class="fa fa-check-square btn btn-success btn-sm ml-2" aria-hidden="true"></i></td>
                                                    @else
                                                        <td> <button type="submit" class="btn btn-warning btn-sm ml-2">set</button> </td>
                                                    @endif
                                                </tr>
                            ...
                            <div class="modal-footer ">
                                ...
                                <div class="col-12 ">
                                    <form action="{{ url('add-grade') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="mx-auto" style="width:85%;">
                                            <div class="row">
                                                <div class="col-md-8 ">
                                                    <input type="number" name="grade" id="grade" min="1" max="50" class="form-control" placeholder="Add a new Grade">
                                                </div>
                                                ...
                                                @endforeach
                                                    ...
                                                    <td>  
                                                        <div class="row d-flex justify-content-center">
                                                            <form action="{{ url('delete-status', $s->id) }}" method="post"  >
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure want to delete status : {{ $value }}?')"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-archive" viewBox="0 0 16 16">
                                                                    <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1V2zm2 3v7.5A1.5 1.5 0 0 0 3.5 14h9a1.5 1.5 0 0 0 1.5-1.5V5H2zm13-3H1v2h14V2zM5 7.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                                                                </svg> </button> 
                                                            </form>
                                                        </div>                                                    
                            ...
                            <div class="modal-footer  d-flex justify-content-center">
                                ...
                                <div class="col-12 ">
                                    <form action="{{ url('add-status') }}" method="POST" >
                                        ...
                                        <input type="hidden" name="emp_id" value="{{ $empInfo->emp_id }}" hidden/>
                                        <div class="row">
                                            <div class="col-md-5 ">
                                            ...
                                            <div class="col-md-5 mt-2 mt-md-0">
                                                <input type="text" name="date" id="" value="{{ $today }}" class="form-control">
                                            </div>
                                            <div class="col-md-2 mt-2 mt-md-0">
                                                <button type="submit"
                                                    class="btn btn-primary btn-info btn-md btn-block">Add</button>
