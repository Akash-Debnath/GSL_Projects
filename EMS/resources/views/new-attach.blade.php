    ...
    <div class="card card-info card-outline card-tabs">
      <div class="card-header p-0 pt-1 border-bottom-0">
        <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="custom-tabs-three-profile-tab" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Same time for all day</a>
          </li>
          <li class="nav-item">
              ...
              <div class="row d-flex justify-content-end">
                <div class="col-md-2">
                  <!-- <button class="btn-sm btn btn-info btn-block">
                    ...
                    show</button> -->
                  <input type="submit" class="btn-sm btn btn-info btn-block" value="show" name="show">
                </div>
              </div>
