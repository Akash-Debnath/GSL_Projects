      ...
      <div class="card-body">
        ...
        @csrf
          <div class="input-group mb-3">
            <input id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus class="form-control" placeholder="Email">
        ...
        <p class="mb-1">
          <a href="{{route('password.request')}}" style="color:red;">Forget your password?</a>
        </p>
      </div>
    </div>
